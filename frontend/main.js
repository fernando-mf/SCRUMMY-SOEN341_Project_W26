...
if (filterTime && filterTime.value) {
  requestUrl.searchParams.set("maxPrepTime", filterTime.value);
}

if (filterDifficulty && filterDifficulty.value) {
  requestUrl.searchParams.set("difficulty", filterDifficulty.value);
}

if (filterCost && filterCost.value) {
  requestUrl.searchParams.set("maxCost", filterCost.value);
}

if (filterTag && filterTag.value) {
  requestUrl.searchParams.set("tag", filterTag.value);
}
      if (mine && userId) {
...
if (resetFiltersBtn) {
  resetFiltersBtn.addEventListener("click", () => {
    ...
    loadRecipes(); // reload recipes after reset
  });
}
    loadRecipes();
  }
